...
主要特点：以起始点为中心向外层层扩展，直到扩展到终点为止(广度优先搜索思想)

## 过程

设置出发点为v，顶点集合{v1,v2,v3,v4,v5....}，v到各顶点距离构成距离集合Dis，Dis{d1,d2,d3.....}，

1. 从Dis中选择最小的di并移除Dis集合，同时移出V集合中所对应的顶点vi，此时v到vi即为最短路径
2. 更新Dis集合，更新规则为：比较v和V集合中各顶点的距离值，与v通过vi到V集合中顶点的距离值，保留较小的一个(同时也应该更新前驱顶点为vi，表明是通过vi到达的)
3. 重复上述两步骤，直到最短路径顶点为目标定点为止
